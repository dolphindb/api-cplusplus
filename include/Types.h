...
enum DATA_TYPE {DT_VOID,DT_BOOL,DT_CHAR,DT_SHORT,DT_INT,DT_LONG,DT_DATE,DT_MONTH,DT_TIME,DT_MINUTE,DT_SECOND,DT_DATETIME,DT_TIMESTAMP,DT_NANOTIME,DT_NANOTIMESTAMP,
	...
	DT_VOID_ARRAY= ARRAY_TYPE_BASE, DT_BOOL_ARRAY, DT_CHAR_ARRAY, DT_SHORT_ARRAY, DT_INT_ARRAY, DT_LONG_ARRAY, DT_DATE_ARRAY, DT_MONTH_ARRAY, DT_TIME_ARRAY, DT_MINUTE_ARRAY, DT_SECOND_ARRAY, DT_DATETIME_ARRAY, DT_TIMESTAMP_ARRAY, DT_NANOTIME_ARRAY, DT_NANOTIMESTAMP_ARRAY,
	DT_FLOAT_ARRAY, DT_DOUBLE_ARRAY, DT_SYMBOL_ARRAY, DT_STRING_ARRAY, DT_UUID_ARRAY, DT_FUNCTIONDEF_ARRAY, DT_HANDLE_ARRAY, DT_CODE_ARRAY, DT_DATASOURCE_ARRAY, DT_RESOURCE_ARRAY, DT_ANY_ARRAY, DT_COMPRESS_ARRAY, DT_DICTIONARY_ARRAY, DT_DATEHOUR_ARRAY, DT_DATEMINUTE_ARRAY,
	DT_IP_ARRAY, DT_INT128_ARRAY, DT_BLOB_ARRAY, DT_OBJECT_ARRAY
};
