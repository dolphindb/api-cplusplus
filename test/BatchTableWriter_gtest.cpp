namespace{
	...
	static vector<string> type = { "BOOL", "CHAR","SHORT", "STRING", "LONG", "NANOTIME","NANOTIMESTAMP", "TIMESTAMP","FLOAT", "DOUBLE","INT", "DATE","MONTH", "TIME","SECOND", "MINUTE","DATETIME", "DATEHOUR", "IPADDR", "INT128", "SYMBOL" };
	...
	static void BatchTableWriter_insert_error_type(string destType, BatchTableWriter& btw) {
		if(destType == "BOOL" || destType== "CHAR"){
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", short(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", long(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", (long long)(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", int(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", double(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", float(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", to_string(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", to_string(1).c_str()));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createShort(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createLong(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createInt(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createDouble(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createFloat(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createDate(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createMonth(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createTime(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createMinute(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createSecond(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createDateTime(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createTimestamp(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createNanoTime(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createNanoTimestamp(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createString("1")));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", Util::createDateHour(1)));
		}
		else if(destType== "SHORT"){
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", bool(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", char(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", long(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", (long long)(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", int(1)));
			EXPECT_ANY_THROW(btw.insert("batchTableWriter", "", double(1)));
