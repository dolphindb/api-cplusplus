...
- [1. Compilation](#1-compilation)
  - [1.1 Compile under Linux](#11-compile-under-linux)
    - [1.1.1 Environment Setup](#111-environment-setup)
    - [1.1.2 Download bin file and header files](#112-download-bin-file-and-header-files)
    - [1.1.3 Compile main.cpp](#113-compile-maincpp)
    - [1.1.4 Compile](#114-compile)
    - [1.1.5 Run](#115-run)
  - [1.2 Compile under Linux](#12-compile-under-windows)
    - [1.2.1 Environment Setup](#121-environment-setup)
    - [1.2.2 Download bin file and header files](#122-download-bin-file-and-header-files)
    - [1.2.3 Environment Setup](#123-build-visual-studio-project)
    - [1.2.4 Environment Setup](#124-compile-and-run)
...
- [7. Write to DolphinDB tables](#7-write-to-dolphindb-tables)
  - [7.1 Save data to a DolphinDB in-memory table](#71-save-data-to-a-dolphindb-in-memory-table)
    - [7.1.1 Save data to an in-memory table with insert into](#711-save-data-to-an-in-memory-table-with-insert-into)
    - [7.1.2 Save data in batches with tableInsert](#712-save-data-in-batches-with-tableinsert)
    - [7.1.3 Use function tableInsert to save TableSP objects](#713-use-function-tableinsert-to-save-tablesp-objects)
...
- [8. Build](#8-build)
  -  [8.1 Linux64](#81-linux64)
    - [8.1.1 Build with cmake](#811-build-with-cmake)
  -  [8.2 Build under Windows with MinGW](#82-build-under-windows-with-mingw)
- [9. Streaming](#9-streaming)
  - [9.1 ThreadedClient](#91-threadedclient)
    - [9.1.1 Define the threaded client](#911-define-the-threaded-client)
    - [9.1.2  Subscribe](#912-subscribe)
    - [9.1.3 Unsubscribe](#913-unsubscribe)
  - [9.2 ThreadPooledClient](#92-threadpooledclient)
    - [9.2.1 Define ThreadPooledClient](#921-define-threadpooledclient)
    - [9.2.2 Subscribe](#922-subscribe)
    - [9.2.3 Unsubscribe](#923-unsubscribe)
  -  [9.3 PollingClient](#93-pollingclient)
    - [9.3.1 Define PollingClient](#931-define-pollingclient)
    - [9.3.2 Unsubscribe](#932-unsubscribe)
# DolphinDB C++ API
