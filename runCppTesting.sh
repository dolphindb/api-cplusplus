...
cd /hdd/hdd1/testing/api/workdir/api-cplusplus/test && make clean && make -j  && rm /hdd/hdd1/testing/api/result/cplusplus/output.txt -rf && ./DolphinDBTest /hdd/hdd1/testing/api/result/cplusplus/output.txt
